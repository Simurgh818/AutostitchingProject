...
def OverLayFFT(img1,img2):
	global ang1, ang2, img1DFT, img2DFT, DFTShift1, DFTShift2, img1_magnitudeSpectrum, img2_magnitudeSpectrum, overlayFFT_mag, img1_LPF_iFFT_mag,img2_LPF_iFFT_mag, img1_HPF_iFFT_mag, img2_HPF_iFFT_mag, overlayFFT_phase, overlayFFT_phase2
	...
	print(DFTShift1[:,:,1])	
	# ang1 = np.angle(DFTShift1[:,:,1])
	# ang2 = np.angle(DFTShift2[:,:,1])
	...
	overlayFFT_phase = ang1[:,1]-ang2[:,1]
	...
	return ang1, ang2, img1DFT, img2DFT, DFTShift1, DFTShift2, img1_magnitudeSpectrum, img2_magnitudeSpectrum, overlayFFT_mag, img1_LPF_iFFT_mag,img2_LPF_iFFT_mag, img1_HPF_iFFT_mag, img2_HPF_iFFT_mag, overlayFFT_phase;
...
plt.subplot(331),plt.plot(ang1[:,1])
plt.title('img1 FFT phase spectrum')
plt.subplot(334),plt.plot(ang2[:,1])
plt.title('img2 FFT phase spectrum')
plt.subplot(337),plt.plot(overLapCorrCoefFFT), plt.title('FFT mag Corr Coef')
